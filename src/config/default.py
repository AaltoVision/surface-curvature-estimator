...
_CN.LOFTR.MATCH_COARSE.ADD_CURV = False # if the curvature features are added
_CN.LOFTR.MATCH_COARSE.CURV_SIGN = True
...
# MegaDepth options
_CN.DATASET.MGDPT_IMG_RESIZE = 840  # resize the longer side, zero-pad bottom-right to square.
...
_CN.TRAINER.N_SAMPLES_PER_SUBSET = 20
