...
def parse_args():
    ...
    parser.add_argument(
        '--add_curvature', action="store_true", help='if the curvature features are added')
...
if __name__ == '__main__':
    ...
    if args.add_curvature:
        config.LOFTR.MATCH_COARSE.ADD_CURV = True
    ...
    if args.add_curvature:
        loguru_logger.info(f"Start testing with cse!")
    else:
